...
int main() {
  ...
  // std::cout << int(std::get<0>(color)) << " " << int(std::get<1>(color)) << " " << int(std::get<2>(color)) << " " << std::endl;
  // std::cout << res - uint8_t(0) << std::endl;
  ...
  // workspace_options.semantic_path = "/mnt/common_storage/luchuanchuan/pc_seg/mask2former_output/labels_m2f";
  ...
  // workspace_options.workspace_path = "/mnt/luchuanchuan/project/pc_seg/data/zhuhai1440/images_2000/dense";
